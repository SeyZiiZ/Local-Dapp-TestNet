        ...
        <section className="relative py-12 lg:py-24 bg-orange-50 overflow-hidden"><img className="absolute bottom-0 left-0" src="fauna-assets/footer/waves-lines-left-bottom.png" alt="" />
            <div className="container px-4 mx-auto relative">
                <div className="flex flex-wrap mb-16 -mx-4">
                    <div className="w-full lg:w-2/12 xl:w-2/12 px-4 mb-16 lg:mb-0"><a className="inline-block mb-4" href="#"><img src="images/logo.svg" alt="" /></a></div>
                    <div className="w-full md:w-7/12 lg:w-6/12 px-4 mb-16 lg:mb-0">
                        <div className="flex flex-wrap -mx-4">
                            <div className="w-1/2 xs:w-1/3 px-4 mb-8 xs:mb-0">
                                ...
                                <ul>
                                    <li className="mb-4"><a className="inline-block text-gray-600 hover:text-lime-500 font-medium" href="#">Solutions</a></li>
                                    <li className="mb-4"><a className="inline-block text-gray-600 hover:text-lime-500 font-medium" href="#">How it works</a></li>
                                    <li><a className="inline-block text-gray-600 hover:text-lime-500 font-medium" href="#">Pricing</a></li>
                                </ul>
                            </div>
                            <div className="w-1/2 xs:w-1/3 px-4 mb-8 xs:mb-0">
                                <h3 className="mb-6 font-bold">Resources</h3>
                                <ul>
                                    <li className="mb-4"><a className="inline-block text-gray-600 hover:text-lime-500 font-medium" href="#">Blog</a></li>
                                    <li className="mb-4"><a className="inline-block text-gray-600 hover:text-lime-500 font-medium" href="#">Help Center</a></li>
                                    <li><a className="inline-block text-gray-600 hover:text-lime-500 font-medium" href="#">Support</a></li>
                                </ul>
                            </div>
                            <div className="w-full xs:w-1/3 px-4">
                                <h3 className="mb-6 font-bold">Company</h3>
                                <ul>
                                    <li className="mb-4"><a className="inline-block text-gray-600 hover:text-lime-500 font-medium" href="#">About</a></li>
                                    <li className="mb-4"><a className="inline-block text-gray-600 hover:text-lime-500 font-medium" href="#">Our Mission</a></li>
                                    <li className="mb-4"><a className="inline-block text-gray-600 hover:text-lime-500 font-medium" href="#">Careers</a></li>
                                    <li><a className="inline-block text-gray-600 hover:text-lime-500 font-medium" href="#">Contact</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div className="flex flex-wrap -mb-3 justify-between">
                    <div className="flex items-center mb-3"><a className="inline-block mr-4 text-black hover:text-lime-500" href="#">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        </svg></a>              <a className="inline-block mr-4 text-black hover:text-lime-500" href="#">
                            ...
                            </svg></a>              <a className="inline-block text-black hover:text-lime-500" href="#">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
